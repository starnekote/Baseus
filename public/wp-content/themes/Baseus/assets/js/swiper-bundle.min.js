...
const catalog = new Swiper('.catalog-categories-swiper', {
  ...
  on: {
    init() {
      // додати клас при завантаженні сторінки
      const swiper = this;
      swiper.slides.forEach(slide => slide.classList.remove('after-six'));
      const targetIndex = swiper.activeIndex + 7;
      const targetSlide = swiper.slides[targetIndex];
      if (targetSlide) {
        targetSlide.classList.add('after-six');
      }
    },
